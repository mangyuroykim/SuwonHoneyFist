...
<c:set var="searchUrl" value="/board/search.kh?searchCondition=${searchCondition}&searchKeyword=${searchKeyword}" />
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <tr>
                <td colspan="5" align="center">
                    <c:if test="${startNavi ne 1}">
                        <a href="${searchUrl}&page=${startNavi -1}">이전</a>
                    </c:if>
                    ...
                    <c:if test="${endNavi ne naviTotalCount}">
                        <a href="${searchUrl}&page=${endNavi + 1}">다음</a>
                    </c:if>
                </td>
            </tr>
            <tr>
