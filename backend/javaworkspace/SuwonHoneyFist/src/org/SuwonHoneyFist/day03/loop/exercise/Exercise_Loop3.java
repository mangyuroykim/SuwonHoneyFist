...
public class Exercise_Loop3 {
	public static void main(String [] args) {
		...
		//입력을 받았고입력받은 값까지 1부터 더해야함.
		//누적합 -> sum 변수 선언
		//누적합식은 sum+= input
		int sum = 0;
		for(int i = 1; i <= input; i++) {  // 1부터 입력한 값까지 증가하여 반복을 해야되기 대문에
...
//			}
//		if( num < 1 ) {
//			System.out.println("1보다 큰 정수를 입력해주세요.");
//		
//		}
//		System.out.println("1부터 " + num + "까지의 정수들의 합 : " + sum);
//		
	}
}
