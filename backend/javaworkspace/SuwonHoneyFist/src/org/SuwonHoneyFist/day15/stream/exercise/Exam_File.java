...
public class Exam_File {
	public static void main(String[] args) throws IOException {
		...
		File fileMake = new File("src/org/SuwonHoneyFist/day15/file/sample");
		if(!fileMake.exists()) {
	...
	public void fileMake() throws IOException {
		File fileMake = new File("src/org/SuwonHoneyFist/day15/file/sample.txt");
		if(!fileMake.exists()) {
			fileMake.createNewFile();
			System.out.println("파일이 만들어졌습니다.");
		} else {
	...
	public void fileBasic() {
		File file = new File("C:\\COPY\\copyimg.jpg");
