package org.SuwonHoneyFist.day11.oop.objectex;
...
class Member {
	...
	public Member(String name, int age, String email, String phone, String address) {// 프로젝트 할때 꼭 해라
		this.name = name;
		this.age = age;
		this.email = email;
		this.phone = phone;
...
//		print(new Member());
		...
		// if(javaStr3 == javaStr2) { -> false, 왜 달라요?
